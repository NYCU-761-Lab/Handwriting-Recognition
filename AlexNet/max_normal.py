...
structure:  AlexNet
pooling:    max
para.pth:   ./max_normal_params.pth
dilate:     kernel(5, 5)
...
"""*"""
a = torch.load('./max_normal_params.pth')
net.load_state_dict(torch.load('./max_normal_params.pth'))
# detect turn on
"""*"""
...
def train():
    ...
    for epoch in range(EPOCH):
        ...
        # 保存模型參數
        torch.save(net.state_dict(), './max_normal_params.pth')
